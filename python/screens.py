...
# This file demonstrates requesting data for MSFT from our screens API.
...
# There are two endpoints in our metrics API: traditional and enhanced
ENDPOINT = 'traditional'

def load_data_to_csv():
  final_csv = '/tmp/new_constructs_{}_screens_sample.csv'.format(ENDPOINT)
  nc_endpoint = 'screens/{}'.format(ENDPOINT)
